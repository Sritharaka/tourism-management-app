...
John Abraham</h5>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="image" type="text" placeholder="images/hotel_1.jpg" class="form-control">
                                            </div>
                                            ...
                                            <button onClick="addHotel()" type="button" class="btn btn-primary">ADD!</button>
                                        </form>
                                    </div>                                    
                                </div>
                            </div>
    ...
    <script src="../scripts/add-hotel.js"></script>
</body>
