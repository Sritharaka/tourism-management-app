    ...
    <div class="super_container">
                        ...
                        <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="main_nav_container ml-auto">
                                <ul class="main_nav_list">
                                    ...
                                    <li class="main_nav_item"><a href="offers.php">Booking</a></li>
                                    <li class="main_nav_item"><a href="hotel.php">Hotel</a></li>
                                    <li class="main_nav_item"><a href="blog.php">About us</a></li>
        ...
        <div class="home">
            ...
            <div class="home_content">
                <div class="home_title">Our Package</div>
            </div>
        </div>
                            ...
                            <div class="hotel_info">
                                ...
                                <div class="hotel_title_container d-flex flex-lg-row flex-column">
                                    <div class="hotel_title_content">
                                        <h1 class="hotel_title">Gayana Hotels Tangalle</h1>
                                        ...
                                        <div class="hotel_location">Gayana Hotel Medaketiya Tissa Road Tangalle</div>
                                    </div>
                                    <div class="hotel_title_button ml-lg-auto text-lg-right">

                                        <div class="hotel_map_link_container">
                                            <div class="hotel_map_link"><a
                                                    href="https://www.google.com/maps/place/Gayana+Hotel/@6.0324178,80.7986773,17.75z/data=!4m6!3m5!1s0x3ae14b28220c37b3:0x538ca8fed9693359!4b1!8m2!3d6.0326767!4d80.8004335">See
                                                    Location on Map</a></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="owl-carousel owl-theme hotel_slider">
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_1.jpg">
                                                    <img src="images/listing_thumb_1.jpg"
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_2.jpg">
                                                    <img src="images/listing_thumb_2.jpg"
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_4.jpg">
                                                    <img src="images/listing_thumb_4.jpg"
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_5.jpg">
                                                    <img src="images/listing_thumb_5.jpg"
                                                        alt="https://unsplash.com/@workweek">
                                                </a>
                                            </div>
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_6.jpg">
                                                    <img src="images/listing_thumb_6.jpg"
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_8.jpg">
                                                    <img src="images/listing_thumb_8.jpg"
                                            ...
                                            <div class="owl-item">
                                                <a class="colorbox cboxElement" href="images/listing_9.jpg">
                                                    <img src="images/listing_thumb_9.jpg"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="room_content">
                                                ...
                                                <div class="room_price">LKR100000.00/One Day</div>
                                                <div class="room_extra">Breakfast LKR1500.00</div>
                                            </div>
                                        </div>
                                ...
                                <div class="room">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="room_content">
                                                <div class="room_title">Double or Twin Room</div>
                                                <div class="room_price">LKR10000.00/night</div>
                                                <div class="room_extra">Breakfast LKR1500.00</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 text-lg-right">
