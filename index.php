						...
						<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
							...
							<div class="main_nav_container ml-auto">
								<ul class="main_nav_list">
									...
									<li class="main_nav_item"><a href="packages.html">Packages</a></li>
									<li class="main_nav_item"><a href="contact.html">contact</a></li>
									<li v-if="isAdmin" class="main_nav_item"><a href="./admin/index.html">Admin Panel</a></li>
								</ul>
							</div>
		...
		<div class="home">
			...
			<div class="home_slider_container">
				...
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slider Item -->
					<div class="owl-item home_slider_item">
						<div class="home_slider_background" style="background-image:url(images/image_slider2.jpg)">
						</div>
					...
					<!-- Slider Item -->
					<div class="owl-item home_slider_item">
						<div class="home_slider_background" style="background-image:url(images/Image_slider3.jpg)">
						</div>
						...
						<div class="search_tabs_container">
							<div
								...
								<div
									...
									<img src="images/island.png" alt="">trips</div>
								<div
									class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
									<img src="images/diving.png" alt="">activities</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="intro_text text-center">
							<p>Gayana include best tours in sri lanka. we provide best facilities in our country also we
								provide goood safety in tour time. </p>
						</div>
					</div>
				</div>
				<div class="row intro_items">
					...
					<div class="col-lg-4 intro_col">
						<div class="intro_item">
							...
							<div class="intro_item_background" style="background-image:url(images/SinharajForest.jpg)">
							</div>
							<div
								class="intro_item_content d-flex flex-column align-items-center justify-content-center">
